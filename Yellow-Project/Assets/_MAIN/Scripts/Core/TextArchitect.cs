...
public class TextArchitect
{
    ...
    public enum BuildMethod { instant, typewritter, fade}
    public BuildMethod buildMethod = BuildMethod.typewritter;
    ...
    private void Prepare_Instant() {
        tmpro.color = tmpro.color; // Looks dumb but isn't, it's for when we change build type
    ...
    private void Prepare_Fade() {
        ...
        for (int i = 0; i < textInfo.characterCount; i++) {
            ...
            if (!charInfo.isVisible) { // TODO Régler le bug avec les caracteres spéciaux, tels que les œ, les â semblent marcher par contre
                continue;
            }
