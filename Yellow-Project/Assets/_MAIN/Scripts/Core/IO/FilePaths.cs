...
public class FilePaths {
    ...
    /// <summary>
    /// Returns the path to the resource using the default path or the root of the resources folder if the resource name starts with the home directory symbol.
    /// </summary>
